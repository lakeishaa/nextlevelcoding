...
// const borderBottomSize = windowHeight - canvasHeight - borderTopSize * 2;
const borderBottomSize = (windowHeight - canvasHeight);
...
border.style.borderBottom = `${borderBottomSize}px solid red`;

...
let defaultImages = ["mySketch0.jpg", "mySketch1.jpg","mySketch2.jpg","mySketch3.jpg", "mySketch4.jpg", "mySketch5.jpg", "mySketch6.jpg", "mySketch7.jpg", "mySketch8.jpg", "mySketch9.jpg","mySketch10.jpg","mySketch11.jpg","mySketch12.jpg","mySketch13.jpg","mySketch14.jpg"]
for(let i=0; i<defaultImages.length; i++){
  localStorage.setItem(`${i}`, defaultImages[i]);
  let img = document.createElement("IMG");
   img.classList.add("galleryImage")
   img.src = `./saved-sketches/${defaultImages[i]}`;
...
function initCanvas() {
  ...
  // seperate function that up

  // function everyThreeIndex(index){
  //   if(index===3){
  //     //draw
  //   }
  ...
  saveBtn.addEventListener("click", () => {
    ...
    let savedImageCounter = items.length;
    ...
    setTimeout(()=>{
      ...
      localStorage.setItem(`${savedImageCounter}`, imgSrc);
...
viewDrawBtn.addEventListener("click", function() {
  ...
  viewDrawBtn.style.backgroundColor = "#E8E5DF";
});
